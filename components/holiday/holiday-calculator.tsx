      ...
      <Card className="mb-6 p-6">
        <div className="flex flex-wrap gap-3 mb-4">
          ...
          >
            ...
            {showHolidayList ? '2026 Tatiller Kapat' : '2026 Tatiller Aç'}
            {showHolidayList ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
          </Button>
          <Button
            variant="outline"
            size="sm"
        ...
        {showHolidayList && (
          <div className="bg-gray-50 rounded-lg p-4 mb-4 max-h-64 overflow-y-auto">
            <h4 className="font-semibold mb-3">2026 Resmî Tatiller</h4>
            <div className="space-y-2">
              {holidays
                .slice()
                .sort((a, b) => a.date.localeCompare(b.date))
                .map((h) => (
                  <div key={h.date} className="flex justify-between text-sm py-1 border-b border-gray-200 last:border-0">
        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <KPICard
              ...
              subLabel="Seçtiğin aralıktaki toplam gün"
              color="green"
            />
            <KPICard
              ...
              subLabel="Hafta içi ve tatil olmayan günler"
              color="orange"
            />
            <KPICard
          ...
          {weeks.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold mb-4">Hafta Hafta Plan</h3>
              <div className="space-y-4">
                {weeks.map((week, idx) => (
                  <div key={week.key} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="text-right">
                        <div className="text-sm text-gray-500">Net izin</div>
