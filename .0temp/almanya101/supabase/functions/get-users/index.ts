...
const ALLOWED_ROL_VALUES = ['Software Developer', 'QA / Test', 'DevOps', 'Data / AI', 'Product / Project', 'UI/UX', 'Ã–ÄŸrenci', 'DiÄŸer']
const ALLOWED_DENEYIM_VALUES = ['0â€“1 yÄ±l', '1â€“3 yÄ±l', '3â€“5 yÄ±l', '5â€“10 yÄ±l', '10+ yÄ±l']
const ALLOWED_IS_ARAMA_VALUES = ['HayÄ±r', 'Evet, pasif (fÄ±rsat olursa)', 'Evet, aktif', 'Sadece freelance bakÄ±yorum']
