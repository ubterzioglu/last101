    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          {/* Header */}
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3">Bize Katıl!</h2>
            <p className="text-sm sm:text-base text-gray-300">almanya101 ekibine katılmak ister misin?</p>
          </div>
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/30">
              <div className="text-gray-200 text-sm sm:text-base leading-relaxed space-y-4 text-justify">
                ...
                <p className="text-google-green font-medium">
                  Katılmak için aşağıdaki iletişim kanallarından bize yazman yeterli!
                </p>
              </div>
            </div>
      ...
      <a 
        href="#"
        className="fixed bottom-6 right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-google-yellow rounded-full flex items-center justify-center shadow-lg hover:bg-yellow-400 hover:scale-110 transition-all duration-300 group"
