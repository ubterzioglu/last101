...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">Araçlar</h2>
            <p className="text-sm text-gray-300">İhtiyacınıza göre hesaplama ve planlama araçları</p>
          </div>

          {/* Araçlar Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-5 max-w-6xl mx-auto mb-12">
            {araclarItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
          ...
          {/* Diğer Başlıklar */}
          <div className="text-center mb-6">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">Diğer Başlıklar</h2>
            <p className="text-sm text-gray-300">Daha fazla bilgi ve içerik</p>
          </div>

          {/* Diğer Başlıklar Grid */}
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {/* WhatsApp */}
            <a href="https://chat.whatsapp.com/JXzMvjJoc57EKDDABSB0jo" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-300 backdrop-blur-sm border border-white/20 group">
            ...
            {/* Telegram */}
            <a href="https://t.me/+UV4iuTECIIg0OWY0" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl bg-white/10 hover:bg-white/20 transition-all duration-300 backdrop-blur-sm border border-white/20 group">
      ...
      {/* Bize Katıl Section - Frankfurt Skyline */}
      <section 
        id="ekibimize-katil"
        className="min-h-[60vh] sm:min-h-[80vh] flex items-center relative bg-cover bg-center py-12 sm:py-0"
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-8 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3">Ekibimize Katıl!</h2>
      ...
      {/* Scroll to Top Button - Fixed Bottom Right (Küçük) */}
      <a
        href="#"
