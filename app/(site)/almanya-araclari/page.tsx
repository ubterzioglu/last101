...
export const metadata = createMetadata({
  title: 'Almanya Araçları Hub',
  description:
    'Almanya101 içindeki tüm interaktif araçları tek sayfada incele, kategori bazında gez ve ilgili araca doğrudan eriş.',
        ...
        <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(66,133,244,0.22),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(251,188,5,0.18),_transparent_28%),rgba(255,255,255,0.03)] p-8 md:p-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="text-sm uppercase tracking-[0.24em] text-white/55">Almanya101 Araç Hub’ı</p>
              <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">
                Tüm araçları tek sayfada incele, karşılaştır ve doğrudan aç
              </h1>
              <p className="mt-4 text-base leading-8 text-white/72 md:text-lg">
                ...
                kanalları dahil tüm araçları tek merkezde topladık. Her kartta ne işe yaradığını
                görebilir ve ilgili araca butonla geçebilirsin.
              </p>
            </div>
