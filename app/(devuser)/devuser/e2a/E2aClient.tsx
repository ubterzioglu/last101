...
const CHOICE_LABELS: Record<string, string> = {
  ...
  'ai-vs-coding': '⚔️ AI vs Geleneksel Kodlama',
  'nonprofit': '🏛️ Kâr Amacı Gütmeyen Dernek',
...
export function E2aClient() {
  ...
  // suppress unused variable warning — adminKey used for reactivity
  void adminKey;
            ...
            <>
              <div className="card">
                <div className="row" style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                  <strong>Event E2 admin oturumu açık</strong>
                  <div className="row">
                    <Link className="btn-secondary" href="/devuser/e2">E2 Sayfası</Link>
              ...
              <div className="card">
                <h2 className="section-title">Konu Oyları</h2>
                        ...
                        filteredVotes.map((item) => (
                          <tr key={item.id}>
                            ...
                            <td className="choices-cell">
                              {Array.isArray(item.selected_topics) && item.selected_topics.length > 0 ? (
                                <div className="choices-wrap">
                                  {item.selected_topics.map((key) => (
