// Sağlayıcı fiyat sabitleri ve maliyet tahmini (corteqs service-finder/src/costs.ts'ten port).
...
export function estimateTavilySearchCost(searchDepth: string): { units: number; amountUsd: number } {
