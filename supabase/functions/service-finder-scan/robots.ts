// robots.txt değerlendirmesi — ekstraksiyondan ÖNCE zorunlu.
// corteqs service-finder/src/robots.ts'ten port (Deno fetch uyumlu).
...
const USER_AGENT = 'almanya101-service-finder/1.0 (+https://almanya101.de)'
